...
<?php include_once('includes/header.php');?>
        ...
        if (!isset($_SESSION["user_id"])) {
          echo '<img src="img/about.jpg" alt="Image">';
        }
         else {
            echo '<img src="img/index_1.jpg" alt="Image">';
        }
    ...
    ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                            Zoyera, It is a car wash management system which is literally going to change the way people think about car cleaning. 
                            ...
                            spray injection and extraction machines, high powered vacuum cleaners, steam cleaners and 
                            so on.
                            </p>
                            <ul>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span style="text-decoration: line-through;">₹399</span></h2>
        ...
        if (!isset($_SESSION["user_id"])) {
           echo '<a class="btn btn-custom" onclick="showAlert()" href="login.php">Book Now</a>';
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>₹</span><strong>699</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (₹399)</option>
                 <option value="2">PREMIUM CLEANING (₹599)</option>
                  <option value="3 ">COMPLEX CLEANING(₹799)</option>
              </select>
...
<?php } ?>
         ...
         <!-- <p><input type="text" name="washingpoint"class="form-control" required placeholder="Location"></p> -->
            ...
            <p>Wash Date <br /><input type="date" name="washdate" required class="form-control"></p>
             ...
             <p><textarea name="message"  class="form-control" placeholder="Address and car number"></textarea></p>
